...
<header class="gerenz">
    <div class="Headportrait t_a_c posr">
        <img src="/packages/mobile/images/img/me.png">
        <span class="g_s_renz x_center">商家认证</span>
    </div>
...
<div class="clearfix gerennav c_333 posr pbt24 w702">
    <a class="b1 fl" href="/mobile/user/credit">
        <img src="/packages/mobile/images/img/im27.png">
        <p class="fs_30 m_t_15">我的保证金</p>
    </a>
    <a class="b2 fl" href="#">
        <img src="/packages/mobile/images/img/im28.png">
        <p class="fs_30 m_t_15">信用级别</p>
    </a>
