            ...
            $.jAjax({
                ...
                success: function (data) {
                    if (data.status == 'success') {
                        alert('新产品创建成功');
                        window.location = '/admin/product/' + data.data.product.id + '/edit';
                    }
                }
            });
        });
    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="box box-primary">
                <form class="form-horizontal j-form" method="post" action="{{ route('admin.product.store') }}">
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control select2" name="user_id">
                                    ...
                                    @foreach($dealers as $dealer)
                                        <option value="{{ $dealer->id }}">{{ $dealer->profile->realname }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="name" placeholder="产品名称" name="name">
                                @if ($errors->has('name'))
                        ...
                        <div class="form-group{{ $errors->has('describe') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="describe" placeholder="产品描述" name="describe">
                        ...
                        <div class="form-group{{ $errors->has('unit') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="unit" placeholder="计量单位" name="unit">
                                @if ($errors->has('unit'))
                                    <span class="help-block">
                        ...
                        <div class="form-group{{ $errors->has('price') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="price" placeholder="单位价格" name="price">
                                @if ($errors->has('price'))
                                    <span class="help-block">
