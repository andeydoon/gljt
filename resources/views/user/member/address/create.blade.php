...
<div class="z_w82p fr z_minh640">
    ...
    <div class="z_mtb10  z_border_b clearfix">
        <span class="z_font14 z_color_3 z_lineh40">添加收货地址</span>
    </div>
    <!--收货地址 -->
    <div class="clearfix z_mt10">
        <div class="z_user_msg z_user_msg2 z_w100p clearfix z_mt20 j-form">
            <div class="z_inputbox clearfix z_mb10">
                ...
                <div class="fl" style="">
                    <input type="text" name="name" placeholder="" class="z_input z_border z_ptb7">
                </div>
            </div>
            <div class="z_inputbox clearfix z_mb10">
                <label class="z_w120 z_lineh30 z_font14 z_color_3 fl">手机号码</label>
                <div class="fl" style="">
                    <input type="text" name="phone" placeholder="" class="z_input z_border z_ptb7">
                </div>
            </div>
            <div class="z_inputbox clearfix z_mb10">
            ...
            <div class="z_inputbox clearfix z_mb10">
                ...
                <div class="z_ml140" style="width: 366px;">
                    <div class="z_text-wrap z_border z_p10 ">
                        <textarea class="z_textarea z_h70" name="street" placeholder="请输入您的详细地址"></textarea>
                    </div>
                </div>
            </div>
            <div class="z_inputbox clearfix z_mb10">
                ...
                <div class="fl" style="">
                    <input type="text" name="floor" placeholder="" class="z_input z_border z_ptb7">
                </div>
            </div>
            <div class="z_inputbox clearfix z_mb10">
                <label class="z_w120 z_lineh30 z_font14 z_color_3 fl">选择电梯情况</label>
                <div class="fl z_lineh30 z_font14 z_color_3" style="">
                    <input type="radio" name="lift" value="1"> 有
                    <input type="radio" name="lift" value="0"> 没有
                </div>
            </div>
            <div class="z_inputbox clearfix z_mb10">
