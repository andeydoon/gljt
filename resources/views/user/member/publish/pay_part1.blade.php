...
<div class="z_w82p fr">
    <div class="z_mtb10 clearfix">
        <span class="z_font14 z_color_3 z_lineh40 z_fontb">支付定金</span>
    </div>
    <!--支付定金-->
    <div class="z_border z_mb10">
        ...
        <div class="z_border_b z_p20 clearfix posr bar-GreyGreed">
            ...
            <span class="z_font12 z_lineh24 posa z_right-20 z_bottom-20 z_index-8 z_color_3">总额：<span
                        class="z_color-orange">￥<span class="z_fontb z_font14">{{ $order->total }}</span></span></span>
        </div>
        <!--支付方式-->
        ...
        <div class="bar-Grey-f4">
            <div class="clearfix z_p10  z_font12 z_color_6 z_lineh24 z_border_b">
                <ul class="clearfix fr" style="display: inline-block;">
                    <li>合计：<span class="z_ml40">￥<span>{{ $order->total }}</span></span></li>
                    <li>定金：<span class="z_ml40">￥<span>{{ $pay_part1 }}</span></span></li>
                </ul>
            </div>
            <div class="z_plr10 z_font12 z_lineh40 z_color_6 tr">
                应付总额：<span class="z_color-orange">￥<span class="z_fontb z_font14">{{ $pay_part1 }}</span></span>
            </div>
        </div>
        <!--结算 end-->
    </div>
    ...
    <div class="z_p10 tr z_mb40">
        <a href="javascript:void(0);" class="z_btn bar-auburn z_font14 z_w110 z_ptb7 j-pay">确认支付</a>
    </div>
    <!--支付定金 end-->
</div>
@endsection
