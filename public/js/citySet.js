    ...
    $("#_citys0 a").click(function () {
        ...
        $("#_citys1 a").click(function () {
            ...
            $("#_citys2 a").click(function () {
                ...
                Iput.colse();
                console.log(ths.value);//最后显示
                var _html ='<span>'+bc + "-" + bp+"-"+$(this).data("name")+'<i class="z_plr5 z_ptb3 z_cursor z_color_red z_ml10 js-z_off">x</i>'+'<input type="hidden" name='+n+' value='+id+'/>'+'</span>';
